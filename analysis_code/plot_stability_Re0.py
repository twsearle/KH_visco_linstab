...
#   Last modified: Wed 23 Oct 16:37:20 2013
#
#------------------------------------------------------------------------------
...
lowBeta = genfromtxt('stability-beta0.1-Re0.dat')
x1,y1 = lowBeta[:,0]/0.1, lowBeta[:,2]*0.1
midBeta = genfromtxt('stability-beta0.5-Re0.dat')
x2,y2 = midBeta[:,0]/0.1, midBeta[:,2]*0.1
highBeta = genfromtxt('stability-beta0.9-Re0.dat')
x3,y3 = highBeta[:,0]/0.1, highBeta[:,2]*0.1
outFilename = 'KH_purely_elastic.pdf'
...
plt.legend( (r'$\beta = 0.1$',r'$\beta = 0.5$'), loc='best' )
ax.set_xlim(0.0,150)
#ax.set_ylim(1,2.)
ax.set_xlabel(r'Wi')
ax.set_ylabel(r'Peak growth rate')
#fig.tight_layout()
