...
#   Last modified: Wed 23 Oct 15:02:08 2013
#
#------------------------------------------------------------------------------
...
lowBeta = genfromtxt('stability-beta0.1-Wi5.0.dat')
x1,y1 = lowBeta[:,0]*0.1, lowBeta[:,2]*0.1
midBeta = genfromtxt('stability-beta0.5-Wi5.0.dat')
x2,y2 = midBeta[:,0]*0.1, midBeta[:,2]*0.1
highBeta = genfromtxt('stability-beta0.9-Wi5.0.dat')
x3,y3 = highBeta[:,0]*0.1, highBeta[:,2]*0.1
outFilename = 'KH_low_Wi_vary_Re.pdf'
...
ax.plot([0], [theIntercept], 'o', color='blue')
ax.plot([0], [midBeta[0,2]*0.1], 'o', color='green')
